...
// Normalizes coverage according to 7 exact categories
function normalizeCoverage(raw: string | undefined): { group: string; subItem: string } {
  ...
  // 5. เบิกต้นสังกัด / รัฐวิสาหกิจ
  if (clean.includes('รัฐวิสาหกิจ') || clean.includes('เบิกต้นสังกัด')) return { group: 'เบิกต้นสังกัด / รัฐวิสาหกิจ', subItem: 'เบิกต้นสังกัด / รัฐวิสาหกิจ' };

  // 6. ประกันสังคม
  if (clean.includes('ประกันสังคม')) return { group: 'ประกันสังคม', subItem: 'ประกันสังคม' };
...
1. ทพญ.กนกวรรณ พัฒนกิจจารักษ์ (กนกวรรณ)
2. ทพญ.ศศิมนต์ วงศ์วัชรานนท์ (ศศิมนต์)
3. ทพญ.ชิดชนก สถิรวิชย์ (ชิดชนก)
4. ทพญ.วีรยา จารุวัต (วีรยา)
5. ทพญ.จิณณพัต อินทร์ยัง (จิณณพัต)
  ...
  "records": [
    {
      ...
      "doctor": "เลือก 1 ใน 5 ท่านนี้เท่านั้น: 'ทพญ.กนกวรรณ พัฒนกิจจารักษ์', 'ทพญ.ศศิมนต์ วงศ์วัชรานนท์', 'ทพญ.ชิดชนก สถิรวิชย์', 'ทพญ.วีรยา จารุวัต', 'ทพญ.จิณณพัต อินทร์ยัง' (หรือระบุเป็น กนกวรรณ, ศศิมนต์, ชิดชนก, วีรยา, จิณณพัต)",
      ...
      "coverage": "ต้องระบุตามโครงสร้างสิทธิ 7 กลุ่มนี้เท่านั้น:
                   - 1. หมวด UC: '30 บาท', 'อสม/ครอบครัว อสม', 'ผู้พิการ', 'สอย.', 'ผู้นำศาสนา', 'ครอบครัวทหารผ่านศึก', 'รายได้น้อย', 'บัตรผู้นำชุมชน', 'บัตรทองฟรี'
                   - 2. หมวด ใช้สิทธิจ่ายตรง: 'ต้นสังกัด (ระบบจ่ายตรง)', 'เบิกจ่ายตรง กทม./อปท.'
                   - 3. หมวด พรบ.: 'พรบ.'
                   - 4. หมวด ชำระเงินเอง: 'ชำระเงินเอง'
                   - 5. หมวด เบิกต้นสังกัด / รัฐวิสาหกิจ: 'เบิกต้นสังกัด / รัฐวิสาหกิจ'
                   - 6. หมวด ประกันสังคม: 'ประกันสังคม'
                   - 7. หมวด อื่นๆ: 'ฟรี'
                   (หากไม่แน่ชัด ให้ระบุ '30 บาท')",
      "coverageGroup": "หนึ่งใน 7 กลุ่มนี้: 'UC', 'ใช้สิทธิจ่ายตรง', 'พรบ.', 'ชำระเงินเอง', 'เบิกต้นสังกัด / รัฐวิสาหกิจ', 'ประกันสังคม', 'อื่นๆ'",
      "labCost": 1200.00,
