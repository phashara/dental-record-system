...
import { WifiOff, CheckCircle2, Layers, Users, DollarSign, Camera, FileText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100 transition-colors duration-200 flex flex-col font-sans antialiased">
      ...
      {!isOnline && (
        <div className="bg-amber-500 text-amber-950 px-4 py-2 text-xs font-semibold text-center flex items-center justify-center space-x-2">
          ...
          <span>ขณะนี้กำลังใช้งานในโหมดออฟไลน์ (Offline Mode) ข้อมูลจะถูกบันทึกไว้ในเครื่อง และซิงค์อัตโนมัติเมื่อต่ออินเทอร์เน็ต</span>
        </div>
      )}
        ...
        <div className="flex items-center justify-around">
          <button
            ...
            className={`flex flex-col items-center py-1 px-2 text-[10px] font-medium transition-colors ${
              currentTab === 'dashboard' ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-zinc-500 dark:text-zinc-400'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-1 px-2 text-[10px] font-medium transition-colors ${
              currentTab === 'records' ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-zinc-500 dark:text-zinc-400'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-1 px-2 text-[10px] font-medium transition-colors ${
              currentTab === 'doctors' ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-zinc-500 dark:text-zinc-400'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-1 px-2 text-[10px] font-medium transition-colors ${
              currentTab === 'lab' ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-zinc-500 dark:text-zinc-400'
            }`}
          >
