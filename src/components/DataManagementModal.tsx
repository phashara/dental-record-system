                ...
                <div className="p-5 rounded-2xl bg-emerald-50/80 dark:bg-emerald-950/20 border-2 border-emerald-200 dark:border-emerald-800/60 space-y-3">
                  ...
                  <div className="pt-1 text-xs text-zinc-600 dark:text-zinc-400 space-y-1">
                    <p className="font-semibold text-zinc-800 dark:text-zinc-200">
                      • ทันตแพทย์ในระบบ 8 ท่าน: ทันตแพทย์ประจำการปัจจุบัน 5 ท่าน (ทพญ.ชิดชนก, ทพญ.วีรยา, ทพญ.จิณณพัต, ทพญ.กนกวรรณ, ทพญ.ศศิมนต์) และทันตแพทย์ในอดีต 3 ท่าน (ทพญ.บุณยาพร, ทพญ.สุนิษา, ทพญ.พัชรพรรณ)
                    </p>
                    <p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 rounded-2xl bg-zinc-100 dark:bg-zinc-800/70 text-xs space-y-1 text-zinc-700 dark:text-zinc-300">
                ...
                <ul className="list-disc list-inside space-y-0.5 text-[11px] text-zinc-600 dark:text-zinc-400 pl-1">
                  ...
                  <li><strong>คอลัมน์มาตรฐาน:</strong> ลำดับ | รหัส | ชื่อ - สกุล | HN | สิทธิการรักษา | ทันตแพทย์ (8 ท่าน) | วัน Insert | จำนวนเงิน (บาท)</li>
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-zinc-600 dark:text-zinc-400">
                      แสดงชื่อ-นามสกุลจริง, เลข HN โรงพยาบาล, ชนิดฟันปลอม, สิทธิการรักษา 7 หมวด, ค่าใช้จ่าย และทันตแพทย์ผู้รักษา (8 ท่าน: ปัจจุบัน 5 ท่าน, อดีต 3 ท่าน) ครบถ้วนตามช่วงวันที่กำหนด
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-red-50/60 dark:bg-red-950/20 border-2 border-red-200 dark:border-red-900/50 space-y-3">
                ...
                <p className="text-xs text-red-700/80 dark:text-red-300 leading-relaxed">
                  ล้างข้อมูลเวชระเบียนทั้งหมดในฐานข้อมูลและแคชให้เหลือ 0 รายการ เพื่อเตรียมพร้อมสำหรับเริ่มลงบันทึกผู้ป่วยจริงในคลินิกทันตกรรม โดยคงการจำแนกประเภทฟันปลอมและรายชื่อทันตแพทย์ทั้ง 8 ท่านไว้สมบูรณ์
                </p>
